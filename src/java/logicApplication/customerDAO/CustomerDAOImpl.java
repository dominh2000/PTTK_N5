...
public class CustomerDAOImpl implements CustomerDAO{
    ...
    public boolean addCust(Customer cus, Account acc, FullName name, Address addr) {
        ...
        String query_1 = "INSERT INTO account (id,employeeID,customerID,username,password) values (?,?,?,?,?)";
        String query_2 = "INSERT INTO fullname (id,employeeID,customerID,firstname,lastname,midname) values (?,?,?,?,?,?)";
        String query_3 = "INSERT INTO address (id,employeeID,customerID,nohouse,street,district,city)";
        String query_4 = "INSERT INTO customer (customerID,telephone,dateofbirth) ";
    ...
    public List<Customer> getAllCustomer() {
        ...
        try {
            ...
            while(rs.next()){
                ...
                String query_Fullname = "SELECT * FROM name where name.customerID = ?";
                ...
                while(rs_2.next()){
                    ...
                    int customerID_fullname = rs_2.getInt("customerID");
                ...
                String query_Account = "SELECT * FROM account where account.customerID = ?";
                ...
                String query_Address = "SELECT * FROM address where address.customerID = ?";
